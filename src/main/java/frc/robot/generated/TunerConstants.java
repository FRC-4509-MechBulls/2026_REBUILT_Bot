...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            ...
            new DifferentialConstantsConfigs()
                .withPeakDifferentialDutyCycle(1)
                .withPeakDifferentialVoltage(12)
        );
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.73); //4.73
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.4287109375);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.45703125);
